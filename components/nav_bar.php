    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
            <ul class="navbar-nav mb-2 mb-lg-0 text-dark">
                ...
                <li><a name="shopping cart icon " id="shopping-cart" class="nav-link" href="#" style="padding-top:0px !important; "><span style="position:relative;"> <span class="card-notification text-primary" style="font-size:large !important; font-weight:800; position:absolute; right:13px; top:-3px;"></span>
